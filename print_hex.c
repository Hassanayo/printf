...
/**
 * print_hex - function to print an unsigned int in hex form
...
/**
 * print_X - takes am unsigned int and prints it in uppercase hex
 * @X: unsigned int to be printed
 *
 * Return: returns the number of digits printed
 */
 ...
 *
 * Return: returns the base ^ exponent
 */
...
/**
 * print_p - function to print an address
